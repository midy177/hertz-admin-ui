export default {
  api: {
    ...
    statusMsg401: '用户没有权限（令牌、用户名、密码错误）!',
    statusMsg403: '用户得到授权，但是访问是被禁止的。!',
    statusMsg404: '网络请求错误,未找到该资源!',
    statusMsg405: '网络请求错误,请求方法未允许!',
    statusMsg408: '网络请求超时!',
    statusMsg500: '服务器错误,请联系管理员!',
    statusMsg501: '网络未实现!',
    statusMsg502: '网络错误!',
    statusMsg503: '服务不可用，服务器暂时过载或维护!',
    statusMsg504: '网络超时!',
    statusMsg505: 'http版本不支持该请求!',
  },
