export default {
  api: {
    ...
    statusMsg401: 'The user does not have permission (token, user name, password error)!',
    statusMsg403: 'The user is authorized, but access is forbidden!',
    statusMsg404: 'Network request error, the resource was not found!',
    statusMsg405: 'Network request error, request method not allowed!',
    statusMsg408: 'Network request timed out!',
    statusMsg500: 'Server error, please contact the administrator!',
    statusMsg501: 'The network is not implemented!',
    statusMsg502: 'Network Error!',
    statusMsg503: 'The service is unavailable, the server is temporarily overloaded or maintained!',
    statusMsg504: 'Network timeout!',
    statusMsg505: 'The http version does not support the request!',
  },
  app: {
    logoutTip: 'Reminder',
